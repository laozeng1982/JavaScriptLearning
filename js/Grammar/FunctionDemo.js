...
log.info("This a \"if \" function demo!");
...
log.info("This a \"if else \" function demo!");

function ifElseDemo1(age) {
    if (age >= 18) {
        status = "Adult";
    } else {
        status = "Youth"
...
//
log.info("This a \"function as class \" demo!");
...
log.info("This a \"if else if\" function demo!");

function ifElseDemo2() {
...
log.info("This a \"switch\" function demo!");
